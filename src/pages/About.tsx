...
const About = () => (
  <section className="dark space-y-8 rounded-3xl border border-white/10 bg-slate-900/95 p-8 shadow-2xl shadow-black/40">
    <div>
    ...
    <div className="grid gap-4 md:grid-cols-2">
      {stack.map((tech) => (
        ...
        >
          ...
          <p className="text-slate-300">{tech.detail}</p>
        </div>
      ))}
    </div>

    <p className="text-sm text-slate-300">
      Try editing <code className="font-mono text-sky-400">src/components/ThreeScene.tsx</code> to
